        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in">
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold text-foreground mb-6">
              Hi, I'm{" "}
              <span className="text-portfolio-accent">John Doe</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Button asChild size="lg" className="bg-portfolio-accent hover:bg-portfolio-accent/90 text-portfolio-accent-foreground">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-slide-up">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                ...
                modern, responsive, and accessible applications using the latest technologies.
                I'm passionate about clean code, user experience, and bringing ideas to life.
              </p>
